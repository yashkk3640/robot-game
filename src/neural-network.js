...
class NeuralNetwork {
  ...
  feedForward(inputArray) {
    // console.log(this._bias0, this._bias1, this._weights0, this._weights1);
  ...
  getMatrices() {
    return {
      bias0: this.bias0,
      bias1: this.bias1,
      weights0: this.weights0,
      weights1: this.weights1
    };
  }
  setMatrices(obj) {
    this._bias0 = new Matrix(obj.bias0._rows, obj.bias0._cols, obj.bias0._data);
    this._bias1 = new Matrix(obj.bias1._rows, obj.bias1._cols, obj.bias1._data);
